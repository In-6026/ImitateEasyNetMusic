    ...
    <div class="player-case flex fillWidth" @mousemove.capture="dragProgressIcon($event)"
        ...
        <div class="playerconsole-warp flex">
            ...
            <div class="music-cover">
                ...
                <img :src="store.state.Player.current.backgroundPic + '?param=34y34'"
                    class="fillHeight fillWidth no-select" />
            </div>
            <!-- 音乐信息&进度条 -->
            ...
            <div class="music-list-control flex">
                <!-- 音量条 -->
                <div @mousemove.capture="dragVolumeIcon($event)" @mouseup="stopDragVolume()"
                    @mouseleave="stopDragVolume()" v-show="!hideVolumeKey" class="volume-case">
