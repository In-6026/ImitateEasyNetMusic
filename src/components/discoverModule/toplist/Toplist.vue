            ...
            <div class="tl-warp fillWidth">
                ...
                <ul>
                    <li v-for="(speacial, index) in toplist?.slice(0, 4)" class="list-none pointer fillWidth tl-li"
                        :class="{ tlLiActive: 'spe' + index === musiclistActive.index }"
                        @click="getMusicListInfo('spe', index)" :key="speacial.id">
                ...
                <ul>
                    <li v-for="(global, index) in toplist?.slice(4)" class="list-none pointer fillWidth tl-li"
                        :class="{ tlLiActive: 'glo' + index === musiclistActive.index }"
                        @click="getMusicListInfo('glo', index)" :key="global.id">
