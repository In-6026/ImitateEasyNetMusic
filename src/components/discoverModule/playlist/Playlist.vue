...
<template>
    ...
    <div class="pl-con relative">
        ...
        <div v-show="typeCtrl.open" class="cateListBox absolute">
            ...
            <div class="bd">
                <h3 class="pointer">
                    <router-link to="?cat=全部" @click="getPlayList('全部'); typeCtrl.close()"
        ...
        <ul class="m-cvrlist flex flex-warp">
            <li v-for="album in  typeCtrl.data" :key="album.id">
                ...
                <p class="auth">
                    ...
                    <img :src="authorIcon(album.creator.userType, album.creator.vipType)" width="13" height="13"
                        loading="lazy" />
                </p>
            </li>
        </ul>
        ...
        <div class="page-turning fillWidth flex flex-item-center">
            ...
            <a @click="typeCtrl.turn(typeCtrl.total)" class="page"
                :class="{ active: typeCtrl.active == typeCtrl.total }">{{ typeCtrl.total }}</a>
