                    ...
                    <ul class="absolute flex" :class="{ hiden: roll.center }">
                        <li v-for="(item, index) in newestAlbumEP" :key="item.id">
                            <div @mouseover="IconHover = index" @mouseleave="IconHover = -1" class="na-con relative">
                                ...
                                <a @click="playAlbum(item)" class="icon-play absolute pointer"
                                    v-show="index == IconHover"></a>
                            </div>
                            <p class="f-third">
        ...
        <div class="rank m-width">
            ...
            <div class="rank-con flex">
                <dl v-for="(rankInfo, rankIndex) in rank.songs" class="fillHeight" :key="rank.id[rankIndex]">
                    <dt class="top flex">
                        <div class="cover relative">
                            ...
                            <router-link :to="'/discover/toplist?id=' + rank.id[rankIndex]"
                                class="absolute fillWidth fillHeight" :title="rank.name[rankIndex]"></router-link>
                        </div>
                        <div class="title">
                            <router-link :to="'/discover/toplist?id=' + rank.id[rankIndex]">
                    ...
                    <dd>
                        <ol>
                            <li @mouseover="rank.iconCtrl[rankIndex] = songIndex"
                                @mouseleave="rank.iconCtrl[rankIndex] = -1"
                                v-for="(songInfo, songIndex) in rankInfo.songs" :key="songInfo.id"
                                ...
                                <p class="r-m-name pointer fillHeight"
                                    ...
                                    {{ songInfo.name }}</p>
                                <div class="r-m-icons flex flex-item-center"
                                    v-show="rank.iconCtrl[rankIndex] === songIndex">
